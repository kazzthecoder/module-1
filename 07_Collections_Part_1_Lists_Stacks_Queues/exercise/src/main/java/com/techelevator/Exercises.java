...
public class Exercises {
	...
	** INTERVIEW QUESTION **
	...
	public List<String> fizzBuzzList(Integer[] integerArray) {
		...
		for (Integer fizzBuzzChecker: integerArray){
			if (fizzBuzzChecker % 3 == 0 && fizzBuzzChecker % 5 == 0){
				fizzBuzzList.add("FizzBuzz");
			} else if (fizzBuzzChecker % 3 == 0){
				fizzBuzzList.add("Fizz");
			} else if (fizzBuzzChecker % 5 == 0){
				fizzBuzzList.add("Buzz");
			} else {
				fizzBuzzList.add(fizzBuzzChecker.toString());
			}
		}
